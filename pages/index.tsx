		...
		<>
			<div className='sidebar'>
				<nav className='absolute w-[600px] top-[50%] -rotate-90 -right-[200px] uppercase z-50'>
					<ul className='flex w-full h-full text-black text-[20px] pt-8 justify-between'>
			...
			<main className={archivo.className}>
				<section className='flex flex-col h-screen w-screen mx-auto'>
					...
					<Link
						href='/contact'
						className='absolute flex right-36 top-8 p-8 bg-black text-white text-[24px] h-2 w-56 items-center justify-center z-30'
					>
						Hire Us
					</Link>
